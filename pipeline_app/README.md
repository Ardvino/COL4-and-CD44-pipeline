...
**This app is for local/internal use only.** It reads and writes the real
project data files already committed in this repo (patient numbers, IHC
scores, clinical variables) directly off disk — there is no upload flow and
it is not meant to be deployed publicly. (The unrelated
